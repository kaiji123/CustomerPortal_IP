...
class VehicleChoice extends Component{
    ...
    render() {
        ...
        return (
            <div className="card SecondColumn Vehicle" >
              <div className="card-body"> 
              <h5 className="card-title">Choose your vehicle</h5> 
              </div>
             <div onClick={this.handleClickSmall} className= {this.state.isMediumOn? "notselected": "selected"} >
                    <img className ="notselected image" src="./Small.png" alt="" />
                </div>
                <div onClick={this.handleClickMedium} className= {this.state.isMediumOn? "selected": "notselected"} >
